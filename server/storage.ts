import { 
  ...
  promptTags, type PromptTag, type InsertPromptTag,
...
export class MemStorage implements IStorage {
  ...
  constructor() {
    ...
    const defaultTags = [
      "writing", "storytelling", "fiction", "business", "marketing", 
      "analysis", "coding", "optimization", "software", "education",
      "learning", "teaching", "wellness", "health", "lifestyle",
      "character", "creative"
    ];
  ...
  async getPromptWithDetails(id: number): Promise<PromptWithDetails | undefined> {
